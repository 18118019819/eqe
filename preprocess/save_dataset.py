...
if __name__ == '__main__':
    ...
    # python save_dataset.py --ace --data_folder ../data/ace_en/preprocessed_data/
    # python save_dataset.py --ace --data_folder ../data/splits/ACE2005-E/

# 输出到\Event_Query_Extract\data\ace_en\pt
