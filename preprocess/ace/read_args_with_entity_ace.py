...
def read_ace_with_entity(data_dir, output_dir, split_path):
    ...
    for data in splits:
        ...
        for file in files:
            print(file)
        #     ../../data/ace_en/ace/CNN_IP_20030330.1600.06.csv
...
if __name__ == '__main__':
    ...
    if args.ace:
        ...
        pass
#     python read_args_with_entity_ace.py --ace --path ../../data/ace_en/processed_data/ --split_path ../../data/splits/ACE05-E/ --output ../../data/ace_en/preprocessed_data/
